...
export default function ProcessDiagram() {
    ...
    export default function ProcessDiagram() {
        ...
        useEffect(() => {
            fetchMultipleTables().then(items => {
                const grouped = {};
                items.forEach(item => {
                ...
                Object.entries(grouped).forEach(([unit, subUnits]) => {
                    newNodes.push({
                        ...
                        data: { label: unit },
                        style: { width: unitWidth, height: unitHeight, backgroundColor: 'transparent', border: '4px solid #444' },
                        draggable: false,
                        selectable: false,
                    });
                    ...
                    Object.entries(subUnits).forEach(([subUnit, items], index) => {
                        ...
                        newNodes.push({
                            ...
                            data: { label: subUnit },
                            style: { width: unitWidth - 20, height: subUnitHeight - 20, backgroundColor: 'transparent', border: '2px dashed #aaa' },
                            draggable: false,
                            selectable: false,
                        });
