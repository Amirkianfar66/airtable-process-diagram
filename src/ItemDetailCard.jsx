        ...
        <div style={{
            ...
            <section style={sectionStyle}>
                ...
                <div style={rowStyle}>
                    ...
                    <input style={inputStyle} type="text" value={localItem['Class Name'] || ''} onChange={e => handleFieldChange('Class Name', e.target.value)} />
                </div>
                <div style={rowStyle}>
                ...
                <div style={rowStyle}>
                    ...
                    <input style={inputStyle} type="number" value={localItem['Sequence'] || 0} onChange={e => handleFieldChange('Sequence', e.target.value)} />
                </div>
            </section>
            ...
            <section style={sectionStyle}>
                ...
                <div style={rowStyle}>
                    ...
                    <input style={inputStyle} type="text" value={localItem['Supplier Code'] || ''} onChange={e => handleFieldChange('Supplier Code', e.target.value)} />
                </div>
            </section>
            ...
            <section style={sectionStyle}>
                ...
                <div style={rowStyle}>
                    ...
                    <input style={inputStyle} type="text" value={localItem['Size'] || ''} onChange={e => handleFieldChange('Size', e.target.value)} />
                </div>
            </section>
        </div>
    );
